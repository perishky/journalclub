...
candidates.gs <- journalclub.candidates(gs, recent=30)
...
candidates <- journalclub.candidates("input-test", recent=30)
candidates.gs <- journalclub.candidates(gs, query=query, recent=30)
...
candidates.rep.gs <- journalclub.candidates(gs, query=query, recent=30)
...
candidates.rep2.gs <- journalclub.candidates(gs, query=query, recent=30)
...
candidates.mod.gs <- journalclub.candidates(gs, query=query, recent=30)
